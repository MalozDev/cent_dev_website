      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
          ...
          >
            ...
            ></div>
            <div
              className={`relative backdrop-blur-sm rounded-2xl p-6 sm:p-8 h-full transition-all duration-300 text-center lg:text-left ${
                theme === "dark"
            ...
            >
              <div
                className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center mb-4 transition-transform duration-300 group-hover:scale-110 mx-auto lg:mx-0 ${
                  theme === "dark"
          ...
          >
            ...
            >
              ...
              <ul
                className={`space-y-2 text-sm sm:text-base transition-colors duration-300 ${
                  theme === "dark" ? "text-gray-400" : "text-gray-600"
                }`}
              >
