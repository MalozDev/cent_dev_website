      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 px-4">
            <span
              className={`bg-clip-text text-transparent shine-wrapper shine-once shine-delay-2 transition-colors duration-300 ${
                theme === "dark"
        ...
        <div className="space-y-4">
          {FAQS.map((faq, idx) => (
            ...
            >
              ...
              ></div>
              <div
                className={`relative backdrop-blur-sm rounded-xl p-5 sm:p-6 transition-all duration-300 ${
                  theme === "dark"
              ...
              >
                <div className="flex items-start space-x-3">
                  <div
                    className={`w-6 h-6 rounded-lg flex items-center justify-center shrink-0 mt-1 transition-colors duration-300 ${
                      theme === "dark"
